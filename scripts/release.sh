#!/usr/bin/env bash
# release.sh — cut a release for ais-monitor
#
# Usage:
...
echo "  https://github.com/Bennekrouf/ais-monitor/actions"
echo "  Releases page  -> https://mayorana.ch/en/apps/ais-monitor/releases"
