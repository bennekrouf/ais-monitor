...
const LATEST_URL: &str =
    "https://github.com/bennekrouf/ais-monitor/releases/latest/download/latest.json";
const RELEASES_URL: &str = "https://github.com/bennekrouf/ais-monitor/releases/latest";
