    ...
    fn all_succeeded_full_rate_no_streak() {
        let runs = vec![
            run(
                ...
                Some("2026-01-01T10:00:10Z"),
            ),
            run(
                "2",
                "Succeeded",
                "2026-01-01T10:01:00Z",
                Some("2026-01-01T10:01:05Z"),
            ),
        ];
    ...
    fn mixed_runs_correct_rate() {
        let runs = vec![
            ...
            run(
                ...
                Some("2026-01-01T08:00:10Z"),
            ),
            run(
                "4",
                "Succeeded",
                "2026-01-01T07:00:00Z",
                Some("2026-01-01T07:00:10Z"),
            ),
        ];
        let kpi = compute_workflow_kpi(&runs);
    ...
    fn duration_avg_and_p95_computed() {
        ...
        let runs = vec![
            ...
            run(
                ...
                "Succeeded",
                "2026-01-01T10:01:00Z",
                Some("2026-01-01T10:01:04Z"),
            ),
            run(
                "3",
                "Succeeded",
                "2026-01-01T10:02:00Z",
                Some("2026-01-01T10:02:06Z"),
            ),
            run(
                "4",
                "Succeeded",
                "2026-01-01T10:03:00Z",
                Some("2026-01-01T10:04:40Z"),
            ),
        ];
        let kpi = compute_workflow_kpi(&runs);
